<nav class="border-gray-200 bg-red-600 border shadow-lg">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full" id="navbar-hamburger">
            @if (Route::has('login'))
                <ul class="flex flex-col font-medium mt-4 rounded-lg bg-red-600 dark:bg-gray-800 dark:border-gray-700">
                    @auth
                        <li>
