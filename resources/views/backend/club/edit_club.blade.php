...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Edit Club</div>
        <div class="ps-3">
                    ...
                    <div class="card">
                        <form action="{{ route('club.update', ['id' => $club->id]) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Rep ID</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="repId" class="form-control"
                                            value="{{ $club->representative_id }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="totalMembers" class="form-control"
